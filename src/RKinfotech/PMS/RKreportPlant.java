 ...
 * @author rk
 */
public class RKreportPlant extends javax.swing.JInternalFrame {

    /**
     * Creates new form RKreportAnuragDis
     */
    public RKreportPlant() {
        initComponents();
    ...
    private void rkDisplayReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rkDisplayReportActionPerformed
        try {
            ...
            if (rkYear.getSelectedIndex() > 0) {
                ...
                String report = new File("").getAbsolutePath() + "\\src\\RKinfotech\\Reports\\RKplanDis.jrxml";
